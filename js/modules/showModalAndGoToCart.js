...
//buttons
  ...
  const btnAddCartCopy = document.querySelectorAll('[data-button="add-cart-copy"]')//Produtos na pesquisa
...
//Body, sections, modal e pages  
  ...
  const showProduct = document.querySelector('[data-container="show-product"]') //Page do produto
...
//Commands buttons page do carrinho de compras  
  ...
  const modalCommands=()=>{
    const continueShoppingButton = document.querySelector('[data-button="continue"]')//botao de ocultar o modal
